...
TARGET_KEYWORDS = {
    ...
    "role": {"backend": 15.0, "fullstack": 5.0},
}
...
def save_job_to_db(job_data):
    ...
    score, found_stacks = calculate_match_score(
    ...
    if raw_date:
        try:
            # Parse the date string automatically regardless of the format
            job_date = parser.parse(raw_date)
